  ...
  services: [
    {
      ...
      images: [
        {
          url: "https://images.unsplash.com/photo-1487754180477-0177ec5234eb?w=800",
          publicId: "seed-1",
          alt: "Diagnostics",
        },
      ],
    ...
    },
    {
      ...
      images: [
        {
          url: "https://images.unsplash.com/photo-1578844251758-2f71da645217?w=800",
          publicId: "seed-4",
          alt: "Tires",
        },
      ],
    },
    {
      ...
      images: [
        {
          url: "https://images.unsplash.com/photo-1625718675738-7977c22e448d?w=800",
          publicId: "seed-5",
          alt: "Battery",
        },
      ],
...
const seedDatabase = async () => {
  try {
    ...
    const blogsData = sampleData.blogs.map((b) => ({
      ...b,
      author: admin._id,
    }));
